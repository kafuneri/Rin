            ...
            <div className="flex flex-col mb-8 space-y-2 justify-center items-center t-primary ani-show">
                ...
                <p className='text-sm text-neutral-500 font-normal link-line text-center'>
                    ...
                    {config.get<boolean>('rss') && <>
                     ...
                     <br/>
                    <a className='hover:underline' href="https://icp.gov.moe/?keyword=20240729" target="_blank" rel="noopener noreferrer"><img src="https://image.kafuchino.top/api/rfile/icon120.png" alt="Icon" style={{ width: '20px', height: '20px', display: 'inline-block', verticalAlign: 'middle', marginRight: '5px' }} />萌ICP备20240729号</a> | <a className='hover:underline' href="https://travel.moe/go.html?travel=on" title="异次元之旅-跃迁-我们一起去萌站成员的星球旅行吧！" target="_blank" rel="noopener noreferrer">异次元之旅</a>
